...
export default function Header() {
    ...
    return (
		...
		<div className="container">
			...
			<div className="w3l_logo">
				<h1><a href="#">Shopping Mall<span>Your Mall. Your place.</span></a></h1>
			</div>
  ...
  <Menu></Menu>
		...
		<Link to={"/checkoutcart/"}>Proceed to Buy</Link>			
									...
									<div className="tab-1 sign-in resp-tab-content" aria-labelledby="tab_item-0">
										<div className="facts">
											<div className="register">
												...
												<form action="#" method="post">			
													<input onChange={(e)=>setMobile(e.target.value)} name="Mobile" placeholder=" Mobile Number" type="text" required=""/>						
													<input onChange={(e)=>setPassword(e.target.value)}  name="Password" placeholder="Password" type="password" required=""/>										
													<div className="sign-up">
														<input className="btn" onClick={()=>loginApi()} type="button" value="LOGIN"/>
													</div>
												</form>
											</div>
										</div> 
									...
									<div className="tab-2 sign-up resp-tab-content" aria-labelledby="tab_item-1">
										<div className="facts">
											<div className="register">
												...
												<form action="#" method="post">			
													<input onChange={(e)=>setName(e.target.value)} placeholder=" Name" name="Name" type="text" required=""/>
													<input onChange={(e)=>setEmail(e.target.value)} placeholder=" Email Address" name="Email" type="email" required=""/>	
													<input onChange={(e)=>setMobile(e.target.value)} placeholder=" Mobile Number" name="mobile" type="text" required=""/>	
													<input onChange={(e)=>setPassword(e.target.value)} placeholder=" Password" name="Password" type="password" required=""/>	
													<input onChange={(e)=>setRePassword(e.target.value)} placeholder=" Confirm Password" name="Password" type="password" required=""/>
													<div className="sign-up">
						...
						{/* <div className="col-md-4 modal_body_right modal_body_right1">
							<div className="row text-center sign-with">
								<div className="col-md-12">
									<h3 className="other-nw">LOGIN with</h3>
								</div>
								<div className="col-md-12">
									<ul className="social">
